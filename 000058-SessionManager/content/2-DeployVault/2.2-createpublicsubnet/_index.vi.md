...
2. Tại trang **Create NAT gateway**
  + Tại mục **Name tag** điền **Lab NAT**.
  + Tại mục subnet, chọn public subnet ta vừa tạo
  + Chọn Elastic IP (hoặc bấm Allocate Elastic IP)
  + Click **Create NAT gateway**

#### Tạo route table cho public subnet

3.  Tiếp theo chúng ta sẽ tạo một custom route table để gán vào **Lab Public Subnet**.
  + Click **Route Tables**.
...
11. Tại trang **Create route table**.
  + Tại mục **Name**, điền **Lab Public RTB**.
